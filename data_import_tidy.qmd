...
Creating a wider format so that each observation or row is a unique zip code, that the variables then describe the population and median income of
...
```{r}
saveRDS(nyzip_demog_wide_small, file = "nyzip_census.rds")
```
